...
Public Sub SetAutokNyomvonal()
    ...
    For i = LBound(Autok) To AutokSzama
        Select Case i
            Case 1
                Autok(i).SetNyomvonal (Config.Globalis_Nyomvonal And Config.Autok_Elso_Nyomvonal)
            Case 2
                Autok(i).SetNyomvonal (Config.Globalis_Nyomvonal And Config.Autok_Masodik_Nyomvonal)
            Case 3
                Autok(i).SetNyomvonal (Config.Globalis_Nyomvonal And Config.Autok_Harmadik_Nyomvonal)
            Case 4
                Autok(i).SetNyomvonal (Config.Globalis_Nyomvonal And Config.Autok_Negyedik_Nyomvonal)
        End Select
    Next i
End Sub
...
Public Sub SetAutokTokeletesKorozes()
    ...
    For i = LBound(Autok) To AutokSzama
        Select Case i
            Case 1
                Autok(i).SetPontosabbKor (Config.Globalis_TokeletesKorozes And Config.Autok_Elso_TokeletesKorozes)
            Case 2
                Autok(i).SetPontosabbKor (Config.Globalis_TokeletesKorozes And Config.Autok_Masodik_TokeletesKorozes)
            Case 3
                Autok(i).SetPontosabbKor (Config.Globalis_TokeletesKorozes And Config.Autok_Harmadik_TokeletesKorozes)
            Case 4
                Autok(i).SetPontosabbKor (Config.Globalis_TokeletesKorozes And Config.Autok_Negyedik_TokeletesKorozes)
        End Select
    Next i
End Sub
